...
const Toolkit = () => {
  return (
    <div className="hero min-h-screen flex m-10">
     <div>
        <p className="py-6 text-2xl font-semibold text-left text-green-800">
          Complete Design Toolkit – huge collection of
          <br /> elements, rich customization options. Flexible
          <br /> layouts, and instant results! Choose a pre-built
          <br /> header or create a custom layout that perfectly
          <br /> suits your needs.
        </p>
      </div>
      <div className="hero-content grid grid-cols-3 gap-3 ">
